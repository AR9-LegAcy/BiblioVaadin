...
CREATE TABLE biblio.AUTEUR (
    ...
    CREATED_AT_AUTEUR    DATE,
    UPDATED_AT_AUTEUR    DATE,
...
CREATE TABLE biblio.TYPE_AUTEUR (
    ...
    CREATED_AT_TYPE_AUTEUR DATE,
    UPDATED_AT_TYPE_AUTEUR DATE,
...
CREATE TABLE biblio.TYPE_DOCUMENT (
    ...
    CREATED_AT_TYPE_DOCUMENT DATE,
    UPDATED_AT_TYPE_DOCUMENT DATE,
...
CREATE TABLE biblio.TYPE_EVENEMENT (
    ID_TYPE_AUTEUR2      SERIAL NOT NULL,
    NOM_TYPE_EVENT       VARCHAR(100),
    CREATED_AT_TYPE_EVENEMENT DATE,
    UPDATED_AT_TYPE_EVENEMENT DATE,

    CONSTRAINT PK_TYPE_EVENEMENT PRIMARY KEY (ID_TYPE_AUTEUR2)
);

/* Index : TYPE_EVENEMENT_PK */
CREATE UNIQUE INDEX TYPE_EVENEMENT_PK ON biblio.TYPE_EVENEMENT (ID_TYPE_AUTEUR2);
...
CREATE TABLE biblio.BIBLIOTHEQUE (
   ...
   CREATED_AT_BIBLIOTHEQUE DATE,
   UPDATED_AT_BIBLIOTHEQUE DATE,
...
CREATE TABLE biblio.EDITEUR (
    ...
    CREATED_AT_EDITEUR   DATE,
    UPDATED_AT_EDITEUR   DATE,
...
CREATE TABLE biblio.BIBLIOTHECAIRE (
   ...
   CREATED_AT_BIBLIOTHECAIRE DATE,
   UPDATED_AT_BIBLIOTHECAIRE DATE,
...
CREATE TABLE biblio.EMPRUNTEUR (
   ...
   ATTRIBUT_VILLE_EMPRUNTEUR VARCHAR(100) NOT NULL,
   ...
   CREATED_AT_EMPRUNTEUR DATE,
   UPDATED_AT_EMPRUNTEUR DATE,
...
CREATE TABLE biblio.DOCUMENT (
    ...
    CREATED_AT_DOCUMENT   DATE,
    UPDATED_AT_DOCUMENT   DATE,
...
CREATE TABLE biblio.EVENEMENT (
    ...
    ID_TYPE_AUTEUR2      INTEGER NOT NULL,
    ID_BIBLIOTHEQUE      INTEGER NOT NULL,
...
CREATE INDEX EVENEMENT_TYPE_EVENEMENT_FK ON biblio.EVENEMENT (ID_TYPE_AUTEUR2);
...
FOREIGN KEY (ID_TYPE_AUTEUR2)
REFERENCES biblio.TYPE_EVENEMENT (ID_TYPE_AUTEUR2)
ON DELETE RESTRICT ON UPDATE RESTRICT;